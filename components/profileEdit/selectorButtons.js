  ...
  render: function(){
    return(
           <div className="row center col s12 m3 l3">
            ...
            <button className="btn block waves-effect waves-light col s12 m3 l3 blue" onClick={ this.props.toggleActiveComponent.bind(null, 'imageUpload') }>Add Profile Image</button>
          </div>
          )
        }
      });
